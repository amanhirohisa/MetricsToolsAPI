...
/**
 * A code map of a Java source line.
 * <p></p>
 ...
 * (3c) a character within a javadoc,
...
extends CodeLineMap
{
    ...
    /**
     * Constructs a code map of a Java source line.
     * 
     * @param aMap a code map of a Java source line
     */
    ...
    /**
     * Retrieves the number of characters belong to JAVADOC_COMMENT type.
     * 
     * @return the number of characters belong to JAVADOC_COMMENT type
     */
    ...
    /**
     * Returns the string representation of this CodeLineMapForJava in the following format:
     * <br>
     *  (b?,c?,#?:t?,e?,j?,ec?,tc?) ....... 
     * <br>
     ...
     * the character counts of traditional comments, eol comments, javadocs, eol-style commented code, 
     * traditional-style commented code.
     * <br>
     * The ...... part corresponds to the code map.
     * 
     * @return the string representation of this CodeLineMapForJava
     */
    ...
    /** the number of characters corresponding to JAVADOC_COMMENT */
